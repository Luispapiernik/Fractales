...
def main():
    ...
    parser.add_argument('--percent-red', default=0, type=float, metavar='RED',
                        choices=(range(1, 101)), help='percent of color red')
    parser.add_argument('--percent-green', default=0, type=float,
                        metavar='GREEN', choices=(range(1, 101)),
                        help='percent of color green')
    parser.add_argument('--percent-blue', default=0, type=float,
    ...
    parser.add_argument('-n', '--name-image', default='mandelbrot.png',
                        help='name of output image. Default value is mandelbrot.png')
    parser.add_argument('--size', default=(360, 360), type=int, nargs=2,
                        metavar=('WIDTH', 'HEIGHT'),
                        help='size of output image in pixels. Default value is (360, 360)')
